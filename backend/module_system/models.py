...
class User_Progress(models.Model):
	user = models.ForeignKey(User, on_delete=models.CASCADE)
	lesson_completion = models.DecimalField(default=0.0, max_digits=5, decimal_places=2)
	module_completion = models.DecimalField(default=0.0, max_digits=5, decimal_places=2)
